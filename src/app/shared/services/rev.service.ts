...
export class RevService {
  ...
  menuList = [
    {
      ...
      data: [
        ...
        { id: "2", name: "Reyka", cost: 35, qty: 0.05, price: 5.5, round: 0.5 },
        {
          id: "21414",
          name: "Житная",
          cost: 11,
    ...
    },
    {
      ...
      data: [
        ...
        { id: "21350", name: "Узо", cost: 22, qty: 44, price: 4, round: 0.5 },
        {
          id: "21348, 21349",
          name: "Pernod; Ricard",
          cost: 27,
        ...
        { id: "21333", name: "Bols", cost: 25, qty: 44, price: 4, round: 0.2 },
        {
          id: "21334",
          name: "Гренадин",
          cost: 17,
        ...
        { id: "1", name: "Aperol", cost: 25, qty: 44, price: 4, round: 0.5 },
        { id: "21376", name: "фъстък", cost: 0.7, qty: 1, price: 2, round: 1 },
        {
          id: "21374, 21375",
          name: "лешник/бадем",
          cost: 2.5,
        ...
        { id: "23553", name: "Скинос", cost: 33, qty: 23, price: 3, round: 1 },
        {
          id: "23615",
          name: "Maker's Mark",
          cost: 50,
  ...
  public store() {
    ...
    json = JSON.stringify(this.taraSheetView);
    name = "taraData";
    localStorage.setItem(
      name,
      json
