...
export class RevService {
  ...
  constructor(data: DataService) {
    ...
    this.calculateRevSheet("24-06-19");
    this.calculateRevSheet("25-06-19");
  }
  ...
  public revItemCalculator(item, menuItem, date) {
    ...
    var prevDay =
      this.revizia["24-06-19"].filter(i => {
